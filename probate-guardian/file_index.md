...
| [`scripts\audit-window-bridge.mjs`](<scripts/audit-window-bridge.mjs>) | Repository file. |
...
| [`src\core\case-resolver.js`](<src/core/case-resolver.js>) | Build, tooling, or configuration source. |
...
| [`tests\e2e\case-file-roundtrip.spec.ts`](<tests/e2e/case-file-roundtrip.spec.ts>) | Automated test covering the named behavior or contract. |
| [`tests\e2e\case-resolver.spec.ts`](<tests/e2e/case-resolver.spec.ts>) | Automated test covering the named behavior or contract. |
...
| [`tests\e2e\excel-pruned-roundtrip.spec.ts`](<tests/e2e/excel-pruned-roundtrip.spec.ts>) | Automated test covering the named behavior or contract. |
| [`tests\e2e\export-button-guard.spec.ts`](<tests/e2e/export-button-guard.spec.ts>) | Automated test covering the named behavior or contract. |
| [`tests\e2e\feature-load-failure.spec.ts`](<tests/e2e/feature-load-failure.spec.ts>) | Automated test covering the named behavior or contract. |
| [`tests\e2e\filing-identity.contract.spec.ts`](<tests/e2e/filing-identity.contract.spec.ts>) | Automated test covering the named behavior or contract. |
| [`tests\e2e\form-entry-ux.spec.ts`](<tests/e2e/form-entry-ux.spec.ts>) | Automated test covering the named behavior or contract. |
...
| [`tests\e2e\guardian-inventory-tri-state-radios.spec.ts`](<tests/e2e/guardian-inventory-tri-state-radios.spec.ts>) | Automated test covering the named behavior or contract. |
| [`tests\e2e\guardianship-selection-controls.spec.ts`](<tests/e2e/guardianship-selection-controls.spec.ts>) | Automated test covering the named behavior or contract. |
| [`tests\e2e\guided-tour-navigation.spec.ts`](<tests/e2e/guided-tour-navigation.spec.ts>) | Automated test covering the named behavior or contract. |
| [`tests\e2e\highlight-toolbar-style.spec.ts`](<tests/e2e/highlight-toolbar-style.spec.ts>) | Automated test covering the named behavior or contract. |
| [`tests\e2e\legacy-ward-data-normalization.spec.ts`](<tests/e2e/legacy-ward-data-normalization.spec.ts>) | Automated test covering the named behavior or contract. |
...
| [`tests\e2e\navigation-status.contract.spec.ts`](<tests/e2e/navigation-status.contract.spec.ts>) | Automated test covering the named behavior or contract. |
| [`tests\e2e\offline.spec.ts`](<tests/e2e/offline.spec.ts>) | Automated test covering the named behavior or contract. |
| [`tests\e2e\output-semantics.artifact.spec.ts`](<tests/e2e/output-semantics.artifact.spec.ts>) | Automated test covering the named behavior or contract. |
| [`tests\e2e\page-structure.spec.ts`](<tests/e2e/page-structure.spec.ts>) | Automated test covering the named behavior or contract. |
| [`tests\e2e\party-dedupe.spec.ts`](<tests/e2e/party-dedupe.spec.ts>) | Automated test covering the named behavior or contract. |
| [`tests\e2e\party-resolver.spec.ts`](<tests/e2e/party-resolver.spec.ts>) | Automated test covering the named behavior or contract. |
...
| [`tests\e2e\pdf-notice-title.spec.ts`](<tests/e2e/pdf-notice-title.spec.ts>) | Automated test covering the named behavior or contract. |
| [`tests\e2e\pdf-preview-viewer.spec.ts`](<tests/e2e/pdf-preview-viewer.spec.ts>) | Automated test covering the named behavior or contract. |
...
| [`tests\e2e\recovery-cache.spec.ts`](<tests/e2e/recovery-cache.spec.ts>) | Automated test covering the named behavior or contract. |
| [`tests\e2e\routes.spec.ts`](<tests/e2e/routes.spec.ts>) | Automated test covering the named behavior or contract. |
...
| [`tests\e2e\signature-style-removal.spec.ts`](<tests/e2e/signature-style-removal.spec.ts>) | Automated test covering the named behavior or contract. |
| [`tests\e2e\simplified-mount.spec.ts`](<tests/e2e/simplified-mount.spec.ts>) | Automated test covering the named behavior or contract. |
| [`tests\e2e\simplified-part1-identity-cells.spec.ts`](<tests/e2e/simplified-part1-identity-cells.spec.ts>) | Automated test covering the named behavior or contract. |
| [`tests\e2e\simplified-remuneration.spec.ts`](<tests/e2e/simplified-remuneration.spec.ts>) | Automated test covering the named behavior or contract. |
| [`tests\e2e\startup.spec.ts`](<tests/e2e/startup.spec.ts>) | Automated test covering the named behavior or contract. |
| [`tests\e2e\supplemental-pdf-accounting.spec.ts`](<tests/e2e/supplemental-pdf-accounting.spec.ts>) | Automated test covering the named behavior or contract. |
...
| [`tests\e2e\support\target.ts`](<tests/e2e/support/target.ts>) | Build, tooling, or configuration source. |
| [`tests\e2e\support\window-api.ts`](<tests/e2e/support/window-api.ts>) | Build, tooling, or configuration source. |
...
| [`tests\unit\case-file.spec.js`](<tests/unit/case-file.spec.js>) | Automated test covering the named behavior or contract. |
