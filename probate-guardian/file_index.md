...
| [`scripts\ms70-sav-corpus.mjs`](<scripts/ms70-sav-corpus.mjs>) | Milestone 70 (70A) generator of the pre-migration .sav corpus: extracts each checkpoint commit with git archive, serves it, and has that version write its own synthetic case files into tests/fixtures/sav/. |
