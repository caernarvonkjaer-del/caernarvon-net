...
| [`src\core\persistence\case-file.js`](<src/core/persistence/case-file.js>) | Case-file persistence: builds the .sav archive (buildCaseFileBlob(), format version 1), saves it (Save Backup, silent auto-save to the remembered file, download fallback), keeps the remembered file handle, imports and restores backups (importSavArchiveOrWard()), and protectPartiallyReadCaseFile(), which tells the filer exactly which parts of a file could not be read and stops that file being saved over. |
