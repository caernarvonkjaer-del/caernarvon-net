...
| File                                     | Covers                                                                                                                                                                                   |
| ---------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| annual-field-formatting.spec.ts          | Annual Accounting field formatting; shared-write-path parity after persistAnnualControl()'s retirement: one writer per event (two autosaves for input+blur, not three), signed-decimal minus kept and stored as a Number, live amount filtering feeding the running totals, blur-time phone/SSN formatting |
