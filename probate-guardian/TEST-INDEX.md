...
| readiness-predicate-coverage.spec.js | Milestone 38D Phase 2: the four Plans' predicate -> validator-issue-code mapping -- mapped predicate ids are real rows, every unconditionally-required validator field is covered, the deliberately-uncovered list stays honest, and suppression hides only what a pending predicate actually accounts for |
