...
| plan-pdf-wcag-compliance.spec.ts         | Milestone 19-2: Plan-\* features on the shared vector PDF engine; Milestone 43E: CONFIGS-driven loop across the four Plan types, replacing four hand-duplicated bodies                   |
