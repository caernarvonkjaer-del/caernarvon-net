...
const BASELINE = Object.freeze({
  ...
  // Milestone 68E: questions 2, 4 and 5 are checkbox lists now, one boolean
  // per option; the old free-text values live under Other with an explanation.
  q2PrivateResidence: true,
  q3MedPrimary: true,
  q4Other: true, q4Explain: 'Weekly counseling provided by community mental health center',
  q5Other: true, q5Explain: 'Family provides personal care assistance',
  q6CareFacility: true,
...
const CASES = [
  ...
  { autoId: 'plan.q2', override: { q2PrivateResidence: false }, message: '2–3. Setting & Medical Care — Best-suited residential setting is required' },
  ...
  { autoId: 'plan.q4', override: { q4Other: false }, message: '4–5. Mental Health & Personal Care — Mental health service provision is required' },
  { autoId: 'plan.q5', override: { q5Other: false }, message: '4–5. Mental Health & Personal Care — Personal care provision is required' },
