...
// Milestone 43D: merged from attestation-layout.spec.ts -- pure responsive-CSS
// grid column counting (bounding-rect x-coordinate technique), the same
// technique this file already uses against a different card class. It never
// touched a PDF or print route despite TEST-INDEX.md previously filing it
// under pdf-export.
