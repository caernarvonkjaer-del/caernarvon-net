...
// getPdfMetadata() proved out generically enough to extend. (It covered the
// generated DOCX too until Milestone 40A removed that format.)
// This file now also covers the remaining 6 filing types
// (guardian, simplified, and the four Plan types): their identity-resolution
// *mechanism* is already the same shared engine (DESCRIPTORS, PDF
...
// artifact identity, not field-entry behavior. The PDF bytes themselves
// are still produced through the real Save as PDF button and a
...
//   pilot itself only ever checks pdfText contains
...
// - No "filing identifier" PDF metadata assertion. Confirmed this isn't
...
//   forwards metadata.filingId. A pre-existing product gap, not something to paper over with
...
const CONFIGS: IdentityConfig[] = [
  {
    ...
    exportActionAttr: 'data-annual-action', savePdfValue: 'save-pdf',
  ...
  },
  {
    ...
    exportActionAttr: 'data-inventory-action', savePdfValue: 'save-pdf',
  ...
  },
  {
    ...
    exportActionAttr: 'data-simplified-action', savePdfValue: 'save-pdf',
  ...
  },
  {
    ...
    exportActionAttr: 'data-form-action', savePdfValue: 'save-pdf-plan-annual',
  ...
  },
  {
    ...
    exportActionAttr: 'data-form-action', savePdfValue: 'save-pdf-plan-initial',
  ...
  },
  {
    ...
    exportActionAttr: 'data-form-action', savePdfValue: 'save-pdf-plan-minor',
  ...
  },
  {
    ...
    exportActionAttr: 'data-plan-simplified-action', savePdfValue: 'save-pdf',
...
test.describe('Filing identity contract', () => {
  for (const config of CONFIGS) {
    const { filingType: id, createFiling, exportActionAttr, savePdfValue, filenameStem } = config;
    ...
    test(`${id}: sidebar/heading, Summary, and PDF all agree on filing identity`, async ({ page }) => {
