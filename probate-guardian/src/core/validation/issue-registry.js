...
const definitions = Object.freeze({
  ...
  // Milestone 57A's two blocking codes -- filing.bond-waiver.incomplete and
  // filing.restricted-depository.incomplete -- were retired by Milestone 67B:
  // nothing in the bond block gates export any more (src/core/filing/
  // bond-depository.js).
