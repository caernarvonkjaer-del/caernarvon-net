 ...
 * @property {PartyAddress | null} [mailingAddress] - Milestone 49B: a ward's mailing address where
 *   a filing collects it separately from the residence (which is `address`); null until supplied.
