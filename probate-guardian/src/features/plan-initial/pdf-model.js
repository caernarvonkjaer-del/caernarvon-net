  ...
  sections.push({
    ...
    blocks: [
      ...
      ...explainNotice(d.q6Explain),
      {
        ...
        items: [
          { checked: d.q7SocialSecurity === 'Yes' || d.q7SocialSecurity === true, label: 'Social Security' },
          { checked: d.q7Ssdi === 'Yes' || d.q7Ssdi === true, label: 'Social Security Disability Income (SSDI)' },
          { checked: d.q7Hmo === 'Yes' || d.q7Hmo === true, label: 'Health Maintenance Organization (HMO)' },
          { checked: d.q7Ssi === 'Yes' || d.q7Ssi === true, label: 'Supplemental Security Income (SSI)' },
          { checked: d.q7StateSupplement === 'Yes' || d.q7StateSupplement === true, label: 'Optional State Supplement' },
          { checked: d.q7InstitutionalCare === 'Yes' || d.q7InstitutionalCare === true, label: 'Institutional Care Program' },
          { checked: d.q7SupplementalIns === 'Yes' || d.q7SupplementalIns === true, label: 'Supplemental Insurance' },
          { checked: d.q7Pension === 'Yes' || d.q7Pension === true, label: 'Pension' },
          { checked: d.q7Medicare === 'Yes' || d.q7Medicare === true, label: 'Medicare' },
          { checked: d.q7Medicaid === 'Yes' || d.q7Medicaid === true, label: 'Medicaid' },
          { checked: d.q7Va === 'Yes' || d.q7Va === true, label: 'VA' },
          { checked: d.q7Trusts === 'Yes' || d.q7Trusts === true, label: 'Trusts' },
          { checked: d.q7PendingBenefits === 'Yes' || d.q7PendingBenefits === true, label: 'Pending Benefits' },
