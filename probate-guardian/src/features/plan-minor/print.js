  ...
  return `<div>
    ...
    <div class="print-preview-banner no-print">
      ...
      <div class="d-flex gap-2 flex-wrap">
        ...
        <button class="btn btn-primary btn-sm" data-form-action="save-pdf-plan-minor" ${pdfBlocked?'disabled':''}>Save as PDF</button>
...
export async function doSavePdf(){
  ...
  // both blocked by the browser as "multiple files" -- reported live
