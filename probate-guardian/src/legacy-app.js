...
function pagePrintPlanAnnual(){
  // validatePlanAnnual moved to src/features/plan-annual/index.js
  // (Milestone 4, Phase A) -- reached via window since this function hasn't
  // moved yet (Phase B). See that module's file header.
  const errors=window.validatePlanAnnual();
