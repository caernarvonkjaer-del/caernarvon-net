...
async function addWard(wardName,inventoryType){
  ...
  window.D=newWard;
  if(formEngine(inventoryType)==='guardian')await ensureGuardianFeatureReady();
  _visitedPages.clear();
...
// src/features/guardian-inventory/index.js (Milestone 8, Phase A). Print,
// PDF, Excel, shared capacity/PDF helpers, conversion, emptyRowAnnual(),
// and dashboard calc stay legacy for this phase.
