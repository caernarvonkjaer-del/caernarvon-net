...
export const RULES = [
  ...
  [/^(_sessionCacheGet|_cryptoKey|_securityMode|loadCaseFileHandle|readRememberedFile|hasOpenedCaseBefore|getRecentlyOpenedWards|isContinuePromptShown|getCurrentLockedWardId|loadAppState|loadAuditLogEntries|auditLog)$/, 'query:persistenceState'],
